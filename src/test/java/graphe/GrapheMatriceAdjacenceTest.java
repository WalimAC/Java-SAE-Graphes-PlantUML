...
class GrapheMatriceAdjacenceTest {
    ...
    private GrapheMatriceAdjacence graphe;
    ...
    void getSommets_retourneTousLesSommets() {
        ...
        assertTrue(sommets.containsAll(
                List.of("chenille.Chenille", "chenille.Anneau", "chenille.Tete")));
    }
    ...
    @Test
    @DisplayName("ajouterArete : les sommets absents sont créés automatiquement")
    ...
    @Test
    @DisplayName("ajouterArete : ré-ajout de la même arête met à jour l'étiquette")
    ...
    @Test
    @DisplayName("supprimerArete : ne touche pas les autres arêtes")
    ...
    @Test
    @DisplayName("supprimerArete : sans effet ni erreur si l'arête n'existe pas")
    ...
    @Test
    @DisplayName("getSuccesseurs : retourne liste vide pour un sommet feuille")
    ...
    @Test
    @DisplayName("getPredecesseurs : retourne liste vide pour une source sans prédécesseur")
